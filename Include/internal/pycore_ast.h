...
enum _expr_kind {BoolOp_kind=1, NamedExpr_kind=2, BinOp_kind=3, UnaryOp_kind=4,
                  ...
                  TypeExpr_kind=23, Attribute_kind=24, Subscript_kind=25,
                  Starred_kind=26, Name_kind=27, List_kind=28, Tuple_kind=29,
                  Slice_kind=30};
struct _expr {
...
expr_ty _PyAST_Constant(constant value, string kind, int lineno, int
                        col_offset, int end_lineno, int end_col_offset, PyArena
                        *arena);
expr_ty _PyAST_TypeExpr(expr_ty body, int lineno, int col_offset, int
                        end_lineno, int end_col_offset, PyArena *arena);
